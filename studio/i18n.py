...
T: dict[str, dict[str, str]] = {
    ...
    "app_subtitle":     {"zh": "灵感 · 规划 · 创作 · 调研 · 决策", "en": "Inspire · Plan · Create · Research · Decide"},
    "app_desc":         {"zh": "五种模式，帮团队高效获取灵感、出方案、交作业、做调研、理清决策。", "en": "Five modes to help your team brainstorm, plan, create, research, and make decisions."},
    ...
    # ── 卡住了？（决策助手）──
    "mode_stuck":       {"zh": "卡住了？", "en": "Stuck?"},
    "mode_stuck_d":     {"zh": "AI 帮你判断该不该找 Leader，生成 30 秒决策日志", "en": "AI helps decide whether to escalate, generates a 30-second decision log"},
    "dk_title":         {"zh": "🚦 卡住了？", "en": "🚦 Stuck?"},
    "dk_desc":          {"zh": "描述你遇到的情况，AI 会帮你判断该自己决定、先试试看、还是找 Leader，并生成一条决策日志。", "en": "Describe your situation. AI will classify it (handle yourself / try first / escalate to leader) and generate a decision log."},
    "dk_warm":          {"zh": "💬 这个工具只是帮你理清思路，依然欢迎有困惑或灵感时随时沟通。", "en": "💬 This tool just helps you think things through. You're always welcome to reach out whenever you have questions or ideas."},
    "dk_warm_level1":   {"zh": "这件事建议和 Leader 聊一下，TA 的视角会有帮助。", "en": "It'd be good to loop in your leader on this one — their perspective will help."},
    "dk_warm_level2":   {"zh": "可以先按自己的判断试试看，过程中有任何想法随时沟通。", "en": "Trust your call and give it a go. Feel free to reach out anytime along the way."},
    "dk_warm_level3":   {"zh": "这个你完全可以自己搞定，相信自己的判断。💪", "en": "You've totally got this. Trust your judgment and go for it. 💪"},
    "dk_situation":     {"zh": "你遇到了什么情况？", "en": "What situation are you facing?"},
    "dk_situation_ph":  {"zh": "例：海外团队突然要加一个功能，估计要 3 天…", "en": "e.g. The overseas team suddenly wants to add a feature, estimated 3 days..."},
    "dk_owner":         {"zh": "负责人（选填）", "en": "Owner (optional)"},
    "dk_options":       {"zh": "你想到的备选方案（选填）", "en": "Options you've considered (optional)"},
    "dk_options_ph":    {"zh": "A 接受需求延期发布\nB 砍掉次要功能保发布时间\nC 找 Leader 要额外资源", "en": "A Accept and delay release\nB Cut secondary features to keep date\nC Ask leader for extra resources"},
    "dk_start":         {"zh": "帮我判断", "en": "Help Me Decide"},
    "dk_running":       {"zh": "正在分析你的情况…", "en": "Analyzing your situation..."},
    "dk_done":          {"zh": "分析完成", "en": "Analysis Complete"},
    "dk_level":         {"zh": "升级级别", "en": "Escalation Level"},
    "dk_matched":       {"zh": "匹配规则", "en": "Matched Rule"},
    "dk_reason":        {"zh": "判断理由", "en": "Reason"},
    "dk_suggestion":    {"zh": "建议处理流程", "en": "Suggested Process"},
    "dk_log_preview":   {"zh": "📋 决策日志预览", "en": "📋 Decision Log Preview"},
    "dk_save":          {"zh": "确认保存到日志", "en": "Save to Decision Log"},
    "dk_saved":         {"zh": "已保存！", "en": "Saved!"},
    "dk_edit_hint":     {"zh": "你可以先修改下面的内容，再保存", "en": "You can edit the fields below before saving"},
    "dk_tab_new":       {"zh": "新决策", "en": "New Decision"},
    "dk_tab_history":   {"zh": "历史记录", "en": "History"},
    "dk_tab_rules":     {"zh": "升级规则", "en": "Escalation Rules"},
    "dk_no_history":    {"zh": "暂无记录", "en": "No records yet"},
    "dk_export_csv":    {"zh": "导出 CSV", "en": "Export CSV"},
    "dk_rules_edit":    {"zh": "编辑规则", "en": "Edit Rules"},
    "dk_rules_save":    {"zh": "保存规则", "en": "Save Rules"},
    "dk_rules_saved":   {"zh": "规则已更新！", "en": "Rules updated!"},
    "dk_level_1":       {"zh": "🔴 必须找 Leader", "en": "🔴 Must Escalate to Leader"},
    "dk_level_2":       {"zh": "🟡 先试后再找 Leader", "en": "🟡 Try First, Then Escalate"},
    "dk_level_3":       {"zh": "🟢 自己说了算", "en": "🟢 You Decide"},
}
